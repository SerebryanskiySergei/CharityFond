...
<meta name="description" content="Благотворительный фонд Твори Добро" />
<meta name="keywords" content="building,business,construction,cleaning,transport,workshop" />
<meta name="author" content="Sergei Serebryanskiy" />

<!-- Page Title -->
<title>Благотворительный Фонд Твори Добро</title>
...
<div id="wrapper" class="clearfix">
  ...
  <div id="preloader">
    ...
    <div id="disable-preloader" class="btn btn-default btn-sm">Убрать предзагрузчик</div>
  </div>
 ...
 <footer id="footer" class="footer pb-0" data-bg-img="images/footer-bg.png" data-bg-color="#25272e" style="background-color: rgb(37, 39, 46) ! important; background-image: url(&quot;images/footer-bg.png&quot;); background-repeat: repeat ! important; background-attachment: scroll ! important; background-clip: border-box ! important; background-origin: padding-box ! important; background-position: 0% 0% ! important; background-size: auto auto ! important;">
    <div class="container pb-20">
          ...
          <div class="horizontal-contact-widget dark mt-30 pt-30 text-center">
            <div class="col-sm-12 col-sm-4">
              <div class="each-widget"> <i class="pe-7s-phone font-36 mb-10 text-white"></i>
                <h5 class="text-theme-colored">Позвоните нам</h5>
                <p class="text-white">Телефон: <a href="#" class="text-white">+7 900 307 9276</a></p>
              </div>
            </div>
            <div class="col-sm-12 col-sm-4 mt-sm-50">
              <div class="each-widget"> <i class="pe-7s-map font-36 mb-10 text-white"></i>
                <h5 class="text-theme-colored">Адресс</h5>
                <p class="text-white">г.Воронеж ул.Кирова д.5 оф. 309</p>
              </div>
            </div>
            <div class="col-sm-12 col-sm-4 mt-sm-50">
      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="list-inline styled-icons icon-hover-theme-colored icon-gray icon-circled text-center mt-50 mb-30">
    ...
    <div class="container-fluid bg-theme-colored p-20">
      <div class="row text-center">
        <div class="col-md-12">
          <p class="text-white font-11 m-0">Copyright ©2017 Твори Добро. Все права защищены</p>
        </div>
      </div>
    </div>
  </footer>
